...
# CentOS 运行以下脚本
 	...
 	# 替换为中国科技大学的elrepo源
	wget -6 -N -P /etc/yum.repos.d/ https://raw.githubusercontent.com/fscarmen/warp/main/elrepo.repo
...
# 安装 wireguard-go
wget -N -6 -P /usr/bin https://raw.githubusercontent.com/fscarmen/warp/main/wireguard-go

# 安装 wgcf
wget -N -6 -O /usr/local/bin/wgcf https://raw.githubusercontent.com/fscarmen/warp/main/wgcf
