...
# 安装 wgcf
wget -nc -6 -O /usr/local/bin/aaa https://cdn.jsdelivr.net/gh/fscarmen/warp/DiG9/wgcf

# 添加执行权限
chmod +x /usr/bin/wireguard-go /usr/local/bin/aaa
...
cp wgcf-profile.conf /etc/wireguard/aaa.conf
