...
function status(){
	...
	green " IPv4：$(wget -T1 -t1 -qO- -4 ip.gs) " && [[ $(wget -qO- -4 https://www.cloudflare.com/cdn-cgi/trace | grep warp=on) ]] && green " (WARP IPv4) "
	green " IPv6：$(wget -T1 -t1 -qO- -6 ip.gs) " && [[ $(wget -qO- -6 https://www.cloudflare.com/cdn-cgi/trace | grep warp=on) ]] && green " (WARP IPv6) "
	green " $wgcf "
	red "======================================================================================================================\n"
		}    
