...
status(){
	...
	[[ $warpv4 = 1 ]] && green "	IPv4：$v4 ( WARP IPv4 ) $(wget -T1 -t1 -qO- -4 https://ip.gs/country) " || green "	IPv4：$v4 $(wget -T1 -t1 -qO- -4 https://ip.gs/country) "
	[[ $warpv6 = 1 ]] && green "	IPv6：$v6 ( WARP IPv6 ) $(wget -T1 -t1 -qO- -4 https://ip.gs/country) " || green "	IPv6：$v6 $(wget -T1 -t1 -qO- -6 https://ip.gs/country) "
...
install(){
	...
	[[ $(wget -T1 -t1 -qO- -6 https://www.cloudflare.com/cdn-cgi/trace | grep warp=on) ]] && green " IPv6：$(wget -T1 -t1 -qO- -6 ip.gs) ( WARP IPv6 ) $(wget -T1 -t1 -qO- -6 https://ip.gs/country) " || green " IPv6：$(wget -T1 -t1 -qO- -6 ip.gs) $(wget -T1 -t1 -qO- -4 https://ip.gs/country) "
