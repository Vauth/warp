...
status(){
	...
	[[ $warpv4 = 1 ]] && green "	IPv4：$v4 ( WARP IPv4 ) $(wget -qO- -4 https://ip.gs/country) " || green "	IPv4：$v4 $(wget -qO- -4 https://ip.gs/country) "
	[[ $warpv6 = 1 ]] && green "	IPv6：$v6 ( WARP IPv6 ) $(wget -qO- -4 https://ip.gs/country) " || green "	IPv6：$v6 $(wget -qO- -6 https://ip.gs/country) "
