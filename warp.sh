...
# 安装 wireguard-go
wget -N -P --no-check-certificate /usr/bin https://github.com/fscarmen/warp/raw/main/wireguard-go

# 安装 wgcf
wget -N -O --no-check-certificate /usr/local/bin/wgcf https://github.com/ViRb3/wgcf/releases/download/v2.2.3/wgcf_2.2.3_linux_amd64
