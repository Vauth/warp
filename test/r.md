...
- [好处](#好处)
- [为IPv6服务器添加IPv4网络接口方法](r.md#为IPv6服务器添加IPv4网络接口方法)
- [为IPv4服务器添加IPv6网络接口方法](r.md#为IPv4服务器添加IPv6网络接口方法)
- [临时、永久关闭和开启WGCF网络接口](r.md#临时永久关闭和开启WGCF网络接口)
- [WARP原理](r.md#WARP原理)
- [致谢](r.md#致谢下列作者和项目排名不分先后)
