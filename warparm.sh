##### 为 ARM64 架构的 IPv6 only VPS 添加 WGCF，IPv6走 warp #####
...
# 安装 wgcf
sudo wget -nc -O /usr/local/bin/wgcf https://github.com/ViRb3/wgcf/releases/download/v2.2.3/wgcf_2.2.3_linux_arm64
